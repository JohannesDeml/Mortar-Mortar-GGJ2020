...
namespace Supyrb.Common
{
	...
	{
		[MenuItem("Supyrb/Quality Assurance/Selection Statistics")]
		public static void ShowSelectionStatistics()
		{
			if (Selection.activeTransform != null)
			{
				ShowGameobjectSelectionStatistics();
			}
			else
			{
				ShowAssetSelectionStatistics();
			}
		}

		[MenuItem("Supyrb/Quality Assurance/Selection Statistics", true)]
		public static bool ValidateShowSelectionStatistics()
		{
			return Selection.activeTransform != null || Selection.objects != null;
		}

		private static void ShowGameobjectSelectionStatistics()
		{
			int objectCounter = 0;
			int staticObjects = 0;
