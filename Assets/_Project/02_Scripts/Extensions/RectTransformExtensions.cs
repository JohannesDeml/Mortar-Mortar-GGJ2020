// --------------------------------------------------------------------------------------------------------------------
// <copyright file="RectTransformExtensions.cs" company="Supyrb">
...
public static class RectTransformExtensions
{
	...
	public static void SetRelativeWidth(this RectTransform trans, float relativeSize)
	{
		SetSize(trans, new Vector2(trans.rect.size.x + relativeSize, trans.rect.size.y));
	}
	...
	public static void SetRelativeHeight(this RectTransform trans, float relativeSize)
	{
		SetSize(trans, new Vector2(trans.rect.size.x, trans.rect.size.y + relativeSize));
	}
